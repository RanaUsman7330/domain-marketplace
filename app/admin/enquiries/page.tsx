                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      enquiry.status === 'new' ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-200 text-gray-700'
                    } transition-colors`}
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      enquiry.status === 'read' ? 'bg-yellow-600 text-white hover:bg-yellow-700' : 'bg-gray-200 text-gray-700'
                    } transition-colors`}
                    disabled={enquiry.status === 'new' || enquiry.status === 'replied'}
                  >
                    Mark as Replied
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 text-sm rounded ${
                      enquiry.status !== 'closed' ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-gray-200 text-gray-700'
                    } transition-colors`}
